export class Doctor {
  async getDoctorByIssue(issue) {
    try {
      let response = await fetch(`https://api.betterdoctor.com/2016-03-01/doctors?query=${issue}&location=45.512230%2C-122.658722%2C100&sort=distance-asc&limit=25&user_key=1${process.env.API_KEY}`);
